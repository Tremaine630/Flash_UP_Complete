...
namespace tutor.pagemodels
{
    public class DashboardPageModel:PageModelBase
    {
        ...
        private SplashScreenPageModel _splashscreenPM;
        public SplashScreenPageModel SplashScreenPageModel
        {
            get { return _splashscreenPM; }
            set { _splashscreenPM = value; }
        }


        public DashboardPageModel(FlashUpPageModel flashupPM, FlashUp1PageModel flashup1PM, FlashUp2PageModel flashup2PM, SubjectsPageModel subjectsPM, SettingsPageModel settingsPM, SplashScreenPageModel splashscreenPM)
        {
            ...
            SplashScreenPageModel = splashscreenPM;
        }
        ...
        public override Task InitializeAsync(object navigatonDate)
        {
            return Task.WhenAny(base.InitializeAsync(navigatonDate),
                ...
                SplashScreenPageModel.InitializeAsync(null)
                );
        }
    }
}
